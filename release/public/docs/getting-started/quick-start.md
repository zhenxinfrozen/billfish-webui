# Billfish Web Manager 快速入�?

欢迎使用 Billfish Web Manager v0.1.0!

## 什么是 Billfish Web Manager?

Billfish Web Manager 是一个基�?Web 的资源管理系�?专门用于浏览和管�?Billfish 软件的资源库�?

### 主要功能

- **📁 文件浏览** - 浏览所有已导入的媒体文�?
- **🔍 智能搜索** - 根据文件名、标签、类型快速查找资�?
- **🏷�?标签管理** - 查看和管理资源标�?
- **📊 数据分析** - 实时查看资源库统计信�?
- **📚 文档中心** - 完整的使用文档和开发指�?
- **🛠�?工具中心** - 数据库分析和映射生成工具
...
编辑 `config.php` 文件,设置 Billfish 资源库路�?
...
系统使用 SQLite 数据库映�?Billfish 的资源文�?
